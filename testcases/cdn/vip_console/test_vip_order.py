...
@allure.feature("VIP客户控制台,工单列表接口测试")
class Test_Vip_Order(object):
    ...
    @allure.story("域名与工单关联，启用域名-查找新增工单")
    def test_CDN_260911(self):
        url = self.domain_info["listOrder"]
    ...
    @allure.story("域名与工单关联，停用域名-查找停用工单")
    def test_CDN_260983(self):
        url = self.domain_info["listOrder"]
