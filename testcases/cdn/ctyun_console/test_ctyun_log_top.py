...
@allure.feature("CTYUN客户控制台,统计分析-热门分析接口测试")
class Test_Ctyun_Top(object):
    ...
    def setup_class(self):
        ...
        self.uri_hit_data_003 = {
            "data":{"workspaceId":self.workspaceId,"startTime":self.yesterday_time,"endTime":self.day_time,
                    "domain":self.log.get_ctyun_cp_domain(self.console_host, self.workspaceId,'003'),
        ...
        self.uri_miss_data_004 = {
            "data":{"workspaceId":self.workspaceId,"startTime":self.yesterday_time,"endTime":self.day_time,
                    "domain":self.log.get_ctyun_cp_domain(self.console_host, self.workspaceId,'004'),
        ...
        self.uri_hit_data_005 = {
            "data":{"workspaceId":self.workspaceId,"startTime":self.yesterday_time,"endTime":self.day_time,
                    "domain":self.log.get_ctyun_cp_domain(self.console_host, self.workspaceId,'005'),
